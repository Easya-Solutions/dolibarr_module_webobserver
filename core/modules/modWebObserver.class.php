...
/**
 * 	\defgroup   webobserver     Module WebObserver
 *  \brief      WebObserver module descriptor.
 *
 *  \file       htdocs/webobserver/core/modules/modWebObserver.class.php
 *  \ingroup    webobserver
 *  \brief      Description and activation file for module WebObserver
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module WebObserver
 */
class modWebObserver extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'webobserver';

		// Family can be 'base' (core modules),'crm','financial','hr','projects','products','ecm','technic' (transverse modules),'interface' (link with external tools),'ATM Consulting - GPAO','...'
		...
		// Module label (no space allowed), used if translation string 'ModuleWebObserverName' not found (WebObserver is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// Module description, used if translation string 'ModuleWebObserverDesc' not found (WebObserver is name of module).
		$this->description = "WebObserverDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "WebObserverDescription";
		...
		// Key used in llx_const table to save module status enabled/disabled (where WEBOBSERVER is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'css' => array(
				//    '/webobserver/css/webobserver.css.php',
			),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array(
				//   '/webobserver/js/webobserver.js.php',
			),
		...
		// Example: this->dirs = array("/webobserver/temp","/webobserver/subdir");
		$this->dirs = array("/webobserver/temp");

		// Config pages. Put here list of php page, stored into webobserver/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@webobserver");
		...
		$this->langfiles = array("webobserver@webobserver");
		...
		//$this->automatic_activation = array('FR'=>'WebObserverWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('WEBOBSERVER_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('WEBOBSERVER_MYNEWCONST2', 'chaine', 'myvalue', 'This is anATM Consulting - GPAO constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		$this->tabs = array();
		// Example:
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@webobserver:$user->rights->webobserver->read:/webobserver/mynewtab1.php?id=__ID__');  					// To add a new tab identified by code tabname1
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@webobserver:$user->rights->ATM Consulting - GPAOmodule->read:/webobserver/mynewtab2.php?id=__ID__',  	// To add anATM Consulting - GPAO new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		...
		$this->dictionaries=array(
			...
			'tabcond'=>array($conf->webobserver->enabled, $conf->webobserver->enabled, $conf->webobserver->enabled)
		);
		*/

		// Boxes/Widgets
		// Add here list of php file(s) stored in webobserver/core/boxes that contains a class to show a widget.
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'webobserverwidget1.php@webobserver',
			//      'note' => 'Widget provided by WebObserver',
		...
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'$conf->webobserver->enabled', 'priority'=>50)
		// );
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/tables/', 'webobserver');
		$result = $this->_load_tables('/webobserver/sql/');
		if ($result < 0) {
